      ...
      <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
        <div className="min-w-0">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <h1 className="text-lg font-semibold text-slate-900 sm:text-xl">{activeModuleLabel}</h1>
          </div>
          <p className="mt-0.5 max-w-2xl text-xs text-slate-500 sm:text-sm">{activeModuleDescription}</p>
          <div className="mt-2 flex flex-wrap items-center gap-2 text-[11px] sm:text-xs">
            ...
            <span className="hidden rounded-full border border-slate-200 bg-white px-2.5 py-0.5 text-slate-500 sm:inline-flex">
              {userEmail}
            </span>
          </div>
        </div>
        <div className="flex w-full flex-col gap-2 lg:w-auto lg:min-w-[30rem]">
          <div className="flex flex-wrap gap-1.5 rounded-2xl bg-slate-100 p-1">
          {[
            ...
            <button
              key={item.key}
              className={`flex-1 rounded-xl px-2.5 py-1.5 text-sm font-semibold transition ${
          ...
          <div className="grid w-full min-w-0 grid-cols-2 gap-2 lg:min-w-[22rem]">
            <label className="block">
              ...
              <select
                className="w-full truncate rounded-2xl border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-700"
